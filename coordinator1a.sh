...
User = postgres
ExecStart = /usr/bin/pg_autoctl create coordinator --monitor "postgresql://autoctl_node@monitor/pg_auto_failover" --citus-cluster one --name coordinator1a --group 1 --ssl-self-signed --auth trust --run
Restart = always
StartLimitBurst = 0
